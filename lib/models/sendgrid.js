...
const emailCopy = require('models/sengrid-email-copy')
...
module.exports = class SendGridModel {
 ...
 /**
   ...
   * @returns {Promise} resolves when email request is done
   */
  billinErrorToAdmin (organizationName, paymentMethodOwnerEmail) {
    log.info({
      orgName: organizationName,
      paymentMethodOwnerEmail: paymentMethodOwnerEmail
    }, 'billingErrorToAdmin called')
    return this.sendBillingEmail(
      organizationName,
      paymentMethodOwnerEmail,
   ...
   * @returns {Promise} resolves when email request is done
   */
  billinErrorToAllMembers (organizationName, emailsForAllMembersOfTOrganization) {
    log.info({
      orgName: organizationName,
      emailsForAllMembersOfTOrganization: emailsForAllMembersOfTOrganization
    }, 'billinerErrorToAllMembers called')
    return this.sendBillingEmail(
      organizationName,
      emailsForAllMembersOfTOrganization,
...
module.exports.DOCK_CREATED_MESSAGES = emailCopy.DOCK_CREATED_MESSAGES
module.exports.PAYMENT_METHOD_ADDED = emailCopy.PAYMENT_METHOD_ADDED
module.exports.PAYMENT_METHOD_REMOVED = emailCopy.PAYMENT_METHOD_REMOVED

 ...
 * @param   {Organization} organization.email - Contact email for organization from Intercom
 *
...
SendGridModel.prototype.dockCreated = function (organization) {
  ...
  return this.sendEmail({
    ...
    body: DOCK_CREATED_MESSAGES.en.body,
    htmlBody: DOCK_CREATED_MESSAGES.en.htmlBody,

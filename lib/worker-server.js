...
const NotifyInvoicePaymentFailure = require('./workers/organization.invoice.payment-failure')
...
module.exports = new ponos.Server({
  ...
  events: {
    ...
    'organization.invoice.payment-failure': NotifyInvoicePaymentFailure
  }
})

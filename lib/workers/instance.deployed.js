 ...
 * 2. find instanceUser and pushUser and settings
        ...
        function (mongoClient) {
          ...
          .spread(function validateModels (instance, cv) {
            ...
            return Promise.props({
              ...
              instanceUser: mongoClient.findOneUserAsync({ 'accounts.github.id': instance.createdBy.github }),
              ...
              const activeUser = result.pushUser || result.instanceUser

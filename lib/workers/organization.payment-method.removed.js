...
const getUserEmailByGithubId = require('./organization.payment-method.added').getUserEmailByGithubId
const jobSchema = require('./organization.payment-method.added').jobSchema

...
module.exports.task = (job) => {
  ...
  return OrganizationService.getHasPaymentMethodForOrganization(job.organization.id)
    .then((hasPaymentMethod) => {
      if (!hasPaymentMethod) {
        throw new WorkerStopError('Organization does not have a payment method')
      }

...
module.exports = class GitHubBotMessage {
  static render (gitInfo, instance, isolatedInstances) {
    ...
    message += GitHubBotMessage.createLink('your environment', instanceUrl)
  ...
  static renderFooter (isolatedInstances) {
    ...
    if (isolatedLinks.length === 0) {
      return '\n<sub>*From ' + this.createLink('Runnable', 'http://runnable.com') + '*</sub>'
    }
    return '\n' + isolatedLinks + '*— From ' + this.createLink('Runnable', 'http://runnable.com') + '*</sub>'
  }

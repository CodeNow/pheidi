  ...
  * @param {Array} isolatedInstances array of isolated instances if any
  ...
  _render (gitInfo, instance, isolatedInstances) {
    ...
    if (gitInfo.state == "running") 
      message += '<img src="https://s3-us-west-1.amazonaws.com/runnable-design/status-green.svg" title="Running" width="9" height="9">';
    else if (gitInfo.state == "stopped")
      message += '<img src="https://s3-us-west-1.amazonaws.com/runnable-design/status-gray.svg" title="Stopped" width="9" height="9">';
    else if(gitInfo.state == "building")
      message += '<img src="https://s3-us-west-1.amazonaws.com/runnable-design/status-orange.svg" title="Building" width="9" height="9">';
    else 
      message += '<img src="https://s3-us-west-1.amazonaws.com/runnable-design/status-red.svg" title="Failed" width="9" height="9">';


    console.log("DZN-1337");
    message += gitInfo.repo + "/" + gitInfo.branch;

    // message += 'The latest push to PR-' + gitInfo.number;
    ...
    //   message += this._renderIsolatedInstance(isolatedInstances)
    //   return message
    // }
    // const instanceUrl = process.env.WEB_URL + '/' + instance.owner.username + '/' +
    //     instance.name
